##############################################################################/
##############################################################################/
#Analysis of Venturia germination on monospore of the 2021 monitoring
##############################################################################/
##############################################################################/
...
ventuMonogerm21<-read.table("data/2021_PdS_ventu_mono_germ.txt",
...
datamyc<-ventuMonogerm21[ventuMonogerm21$lect_echec!=1,]
...
pdf(file="output/plot_ventuMonogerm21.pdf",width=7)
...
write.table(CompRez, file="output/results_ventuMonogerm21.txt",
