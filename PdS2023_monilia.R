...
monilia23<-read.table("data/2023_PdS_monilia_germ.txt",header=TRUE,
                      stringsAsFactors=TRUE,sep=";")


##############################################################################/
#Regression analysis of population germination for 2023 monitoring plan####
##############################################################################/

datamyc<-monilia23[monilia23$lect_echec!=1,]
...
pdf(file="output/plot_monilia23.pdf",width=7)
...
write.table(CompRez, file="output/results_monilia23.txt",
