##############################################################################/
##############################################################################/
#Analysis of Sclerotinia bioasssay of the 2022 monitoring
##############################################################################/
##############################################################################/
...
sclero22<-read.table("data/2022_PdS_scleroColza.txt",
...
datamyc<-sclero22[sclero22$lect_echec!=1,]
...
pdf(file="output/plot_sclero22.pdf",width=7)
...
write.table(CompRez, file="output/results_sclero22.txt",
