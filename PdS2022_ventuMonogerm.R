##############################################################################/
##############################################################################/
#Analysis of Venturia germination on monospore of the 2022 monitoring
##############################################################################/
##############################################################################/
...
ventuMonogerm<-read.table("data/2022_PdS_Venturia_monospores.txt",
...
datamyc<-ventuMonogerm[ventuMonogerm$lect_echec!=1,]
...
pdf(file="output/plot_ventuMonogerm22.pdf",width=7)
...
write.table(CompRez, file="output/results_ventuMonogerm22.txt",
