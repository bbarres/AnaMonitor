##############################################################################/
##############################################################################/
#Analysis of alternaria mycelial growth experiment of the 2021 monitoring
##############################################################################/
##############################################################################/
...
alterPdT21<-read.table("data/2021_PdS_alternaria_pdt.txt",
                            header=TRUE,stringsAsFactors=TRUE,sep=";")


##############################################################################/
#Regression analysis of isolates mycelial growth for 2021 monitoring plan####
##############################################################################/

datamyc<-alterPdT21[alterPdT21$lect_echec!=1,]
...
pdf(file="output/plot_alterPdT21.pdf",width=7)
...
write.table(CompRez, file="output/results_alternariaPdT21.txt",
