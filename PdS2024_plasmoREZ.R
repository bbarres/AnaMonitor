...
rezMoni<-read.table("data/2024_plasmo_rez.txt",header=TRUE,sep="\t",
...
for (i in 1:length(levels(data2map$themat_ID))){
  ...
  png(file=paste("output/","2024_",temp$themat_ID,temp$pest,".png",sep=""),
...
for (i in 1:length(levels(rezMoni$themat_ID))){
  ...
  png(file=paste("output/","2024_hist",temp$themat_ID,temp$pest,".png",sep=""),
