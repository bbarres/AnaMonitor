##############################################################################/
##############################################################################/
#Analysis of Venturia germination experiment on the 2022 monitoring
##############################################################################/
##############################################################################/
...
ventugerm22<-read.table("data/2022_PdS_Ventu_germ.txt",
...
datamyc<-ventugerm22[ventugerm22$lect_echec!=1,]
...
pdf(file="output/plot_ventugerm22.pdf",width=7)
...
write.table(CompRez, file="output/results_ventugerm22.txt",
