...
#loading the data
datamyc<-read.table("data/2024_PdS_monilia_germ.txt",
...
pdf(file="output/2024_PdSplot_monilia_germ.pdf",width=7)
...
write.table(CompRez,file="output/2024_PdSresults_monilia_germ.txt",
