##############################################################################/
##############################################################################/
#Analysis of Gnomonia mycelial growth experiment on the 2021 monitoring
##############################################################################/
##############################################################################/
...
datamyc<-gnomo21[gnomo21$lect_echec!=1,]
...
CompRez<-data.frame(Species=character(),Subs_Act=factor(),
                    ...
                    ED50=character(),SE=as.character())

#we make a subselection of the data according to the SA
pdf(file="output/plot_gnomonia.pdf",width=7)
