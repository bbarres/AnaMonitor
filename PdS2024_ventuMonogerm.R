##############################################################################/
##############################################################################/
#Script for Venturia monitoring in 2024 CI50
##############################################################################/
##############################################################################/
...
#loading the data
datamyc<-read.table("data/2024_PdS_Ventu_germ.txt",
...
pdf(file="output/2024_PdSplot_venturia.pdf",width=7)
...
write.table(CompRez,file="output/2024_PdSresults_venturia.txt",
