##############################################################################/
##############################################################################/
#Analysis of Venturia germination experiment on the 2021 monitoring
##############################################################################/
##############################################################################/
...
ventugerm21<-read.table("data/2021_PdS_Ventu_germ.txt",
...
pdf(file="output/plot_ventugerm21.pdf",width=7)
...
write.table(CompRez, file="output/results_ventugerm21.txt",
